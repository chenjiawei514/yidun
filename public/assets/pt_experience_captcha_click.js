I$("0c20216832841dcb5dce14b16e7fd49c", function (e, t, a) {
    ...
    var o = function (e) {
        ...
        for (var r = 0; r < t.length; r++) !function (r, o) {
            a.addEvent(r, "click", function (c) {
                if (n !== o) {
                    ...
                    s = {type: l.getAttribute("captcha-type"), mode: l.getAttribute("captcha-mode")};
                    e(s, o)
                }
            })
        }(t[r], r);
        var o = t[n];
        s = {type: o.getAttribute("captcha-type"), mode: o.getAttribute("captcha-mode")};
        e(s, n)
    };
    var c = function (e, t) {
        var n = a.query(".j-custom", !0);
        for (var r = 0; r < n.length; r++) !function (n, r) {
            a.addEvent(n, "click", function () {
                ...
                if (!a) {
                    ...
                    if (t) o.captchaId = i[s.type + "_custom"]; else o.captchaId = "a6ab911423aa49b39abd800c30e1f671";
                    n.innerHTML = "返回默认样式"
    ...
    var l = function () {
        function e(e, a, n, s) {
            ...
            if (e) {
                ...
                s = Object.assign({width: "320px", captchaId: i[n], element: v[a]}, s);
                d && d.destroy();
                d = null;
                initNECaptcha(s, function (e) {
                    d = e
        ...
        function r(e) {
            ...
            for (var r = 0, o = i.length; r < o; r++) a.delClass(i[r], "tcapt-bind--active");
        ...
        for (var b = 0; b < f.length; b++) a.addEvent(f[b], "click", function () {
            l.refresh();
            r()
        });
        o(u);
        c(function (t, a) {
            if (t % 2) e(!0, n, s.type, a); else e(!1, n, s.type, a)
        }, !0)
    };
    var d = function () {
        function e(e, i, s) {
            ...
            if ("popup" === i) s.appendTo = a.query(".tcapt_wrap--pop");
            initNECaptcha(s, function (e) {
                t = e
            })
        }
